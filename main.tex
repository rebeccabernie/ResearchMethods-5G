...
By incorporating stations known as small cells - smaller, more portable base stations - we could bypass the issue of signals being lost through obstacles. In one case, when small cells were placed at 200m intervals, waves broadcast between 70-90GHz showed weakening of wave strength due to atmospheric conditions to be roughly (to be edited.....)
between 0.06 and 0.08 decibels per kilometre in 28 and 38GHz bands, and 
